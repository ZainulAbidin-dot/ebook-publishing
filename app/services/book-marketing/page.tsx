...
export default function BookMarketingPage() {
    ...
    const marketingProcess = [
        { step: "01", title: "Marketing Consultation", description: "We conduct in-depth interviews to understand your marketing objectives—whether it's building fame, establishing credibility, driving revenue, or achieving bestseller status." },
    ...
    const whyChooseUs = [
        ...
        { icon: "🚀", title: "Best-Seller Dreams", description: "From unknown to unforgettable—we fuel your fame and fortune." }
    ];
            ...
            <section className="section" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                <div className="container" style={{ textAlign: 'center' }}>
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', maxWidth: '600px', margin: '0 auto 2rem' }}>From unknown to unforgettable—let us fuel your fame, fortune, and best-seller dreams!</p>
