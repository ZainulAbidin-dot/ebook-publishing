...
export default function EditingPage() {
    ...
    const editingServices = [
        ...
        { icon: "✍️", title: "Rewriting & Paraphrasing", description: "Transform awkward passages into polished prose while maintaining your authentic voice." },
        { icon: "✅", title: "Error-Free Text", description: "Meticulous grammar, punctuation, and spelling corrections for flawless manuscripts." },
        { icon: "📄", title: "Manuscript Formatting", description: "Professional formatting and organization that meets industry publishing standards." },
        { icon: "🔍", title: "Critical Reviews", description: "In-depth analysis to identify and fill plot holes, inconsistencies, and narrative gaps." },
        { icon: "📚", title: "Publishing Support", description: "Comprehensive editing services that prepare your manuscript for successful publication." }
    ];
            ...
            <section className="section">
                <div className="container">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        ...
                        <p style={{ fontSize: '1.1rem', color: 'var(--text-muted)', maxWidth: '700px', margin: '0 auto' }}>We provide outstanding services to ensure your book ends up looking flawless—a masterpiece that impresses a vast audience.</p>
                    </motion.div>
